...
INSERT INTO `gallery` VALUES (1,'Кошки'),(2,'Собаки'),(3,'СМУ'),(4,'новая 111');
...
INSERT INTO `gallery_images` VALUES (1,4,'cat1.jpg'),(2,1,'cat2.jpg'),(3,4,'dog1.jpg'),(4,2,'dog2.jpg'),(5,4,'smu1.jpg'),(6,3,'smu2.jpg');
...
CREATE TABLE `pages` (
  ...
  `gallery_id` int(5) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='все страницы сайта';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-02-25 20:08:07
